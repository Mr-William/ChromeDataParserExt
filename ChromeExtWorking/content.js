...
chrome.runtime.onMessage.addListener(
  function(request, sender, sendResponse) {
    if( request.message === "clicked_browser_action" ) {    
        ...
        var clinicName = doc.getElementById('footer').getElementsByClassName('btn btn-invisible');
        var clinic = clinicName[0].innerText.trim();
        ...
        var info = '====Info Received====' + '\n'
              ...
              +'Clinic Name: ' + clinic + '\n'
              +'Link: ' + link;
        var hyperLink = "=HYPERLINK(\""+link+"\", " +"\""+ patientName[1] +"\")";
